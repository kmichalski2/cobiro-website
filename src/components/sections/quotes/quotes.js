    ...
    <div className="container-fluid">
      ...
      <div className={[QuoteStyles.cards, "flex"].join(" ")}>
        <div
          className={[
            QuoteStyles.quote,
            "card card-visible text-left-xs between-xs flex flex-column",
          ].join(" ")}
        >
            ...
            <div>
              ...
              <div className="flex middle-xs">
                <img
                  ...
                  alt="flag"
                />
                <p className="small">Person Country</p>
              </div>
            </div>
          </div>
          <p className="small">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce
            facilisis faucibus sem, sit amet vestibulum mauris vehicula quis.
            Fusce cursus venenatis diam et sagittis.
          </p>
        </div>
        <div
          className={[
