...
const FeaturedCarouselSlide = props => {
  ...
  return (
    <li
      onClick={props.click}
      className={[
        props.active ? FeaturedCarouselStyles.active : "",
        FeaturedCarouselStyles.slide,
      ].join(" ")}
    >
      <h4>
        <img
        ...
        <img
          src={arrow}
          className={FeaturedCarouselStyles.arrow}
      ...
      <div
        className={
          props.active
            ? ["open slide-text", FeaturedCarouselStyles.text].join(" ")
            : [FeaturedCarouselStyles.text, "slide-text"].join(" ")
        }
      >
